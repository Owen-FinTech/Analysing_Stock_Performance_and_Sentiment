...
bull_24h_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bull_24h.csv')
...
bull_72h_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bull_72h.csv')
...
bull_1w_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bull_1w.csv')
...
bull_2w_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bull_2w.csv')
...
bull_1m_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bull_1m.csv')
...
bull_3m_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bull_3m.csv')
...
bear_24h_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bear_24h.csv')
...
bear_72h_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bear_72h.csv')
...
bear_1w_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bear_1w.csv')
...
bear_2w_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bear_2w.csv')
...
bear_1m_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bear_1m.csv')
...
bear_3m_data = Path('/app/Project_1/blob/main/Timeframes_Resources/bear_3m.csv')
